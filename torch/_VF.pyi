...
def _lstsq_helper(a: Tensor, b: Tensor, cond: _float, driver_name: Optional[str]) -> Tuple[Tensor, Tensor, Tensor]: ...
...
def segment_reduce(data: Tensor, reduce: str, *, lengths: Optional[Tensor]=None, indices: Optional[Tensor]=None, axis: _int=0, unsafe: _bool=False) -> Tensor: ...
@overload
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_amp_foreach_non_finite_check_and_unscale_', '_amp_update_scale', '_assert_async',
 '_baddbmm_mkl_', '_batch_norm_impl_index', '_bmm', '_cast_Byte', '_cast_Char', '_cast_Double',
 ...
 '_convolution_mode', '_convolution_nogroup', '_copy_from', '_ctc_loss', '_cudnn_ctc_loss',
 ...
 '_fft_c2c', '_fft_c2r', '_fft_r2c', '_foreach_abs', '_foreach_abs_', '_foreach_acos',
 ...
 '_foreach_atan_', '_foreach_ceil', '_foreach_ceil_', '_foreach_cos', '_foreach_cos_',
 ...
 '_foreach_frac_', '_foreach_lgamma', '_foreach_lgamma_', '_foreach_log', '_foreach_log10',
 '_foreach_log10_', '_foreach_log1p', '_foreach_log1p_', '_foreach_log2', '_foreach_log2_',
 '_foreach_log_', '_foreach_maximum', '_foreach_minimum', '_foreach_mul', '_foreach_mul_',
 '_foreach_neg', '_foreach_neg_', '_foreach_reciprocal', '_foreach_reciprocal_', '_foreach_round',
 '_foreach_round_', '_foreach_sigmoid', '_foreach_sigmoid_', '_foreach_sin', '_foreach_sin_',
 ...
 '_foreach_trunc', '_foreach_trunc_', '_foreach_zero_', '_fused_dropout',
 '_grid_sampler_2d_cpu_fallback', '_has_compatible_shallow_copy_type', '_index_copy_',
 '_index_put_impl_', '_linalg_inv_out_helper_', '_linalg_qr_helper', '_linalg_solve_out_helper_',
 '_log_softmax', '_log_softmax_backward_data', '_logcumsumexp', '_lstsq_helper', '_lu_solve_helper',
 '_lu_with_info', '_make_dual', '_make_per_channel_quantized_tensor',
 '_make_per_tensor_quantized_tensor', '_masked_scale', '_mkldnn_reshape', '_mkldnn_transpose',
 '_mkldnn_transpose_', '_mode', '_nnpack_available', '_nnpack_spatial_convolution',
 '_pack_padded_sequence', '_pad_packed_sequence', '_remove_batch_dim', '_reshape_from_tensor',
 '_rowwise_prune', '_s_where', '_sample_dirichlet', '_saturate_weight_to_fp16', '_shape_as_tensor',
 ...
 '_sparse_coo_tensor_unsafe', '_sparse_log_softmax', '_sparse_log_softmax_backward_data',
 '_sparse_mask_helper', '_sparse_mm', '_sparse_softmax', '_sparse_softmax_backward_data',
 '_sparse_sparse_matmul', '_sparse_sum', '_stack', '_standard_gamma', '_standard_gamma_grad',
 '_std', '_syevd_helper', '_test_serialization_subcmul', '_trilinear', '_unique', '_unique2',
 '_unpack_dual', '_use_cudnn_ctc_loss', '_use_cudnn_rnn_flatten_weight',
 '_validate_sparse_coo_tensor_args', '_var', '_weight_norm', '_weight_norm_cuda_interface', 'abs',
 ...
 'affine_grid_generator', 'all', 'allclose', 'alpha_dropout', 'alpha_dropout_', 'amax', 'amin',
 'angle', 'any', 'arange', 'arccos', 'arccos_', 'arccosh', 'arccosh_', 'arcsin', 'arcsin_',
 'arcsinh', 'arcsinh_', 'arctan', 'arctan_', 'arctanh', 'arctanh_', 'argmax', 'argmin', 'argsort',
 'as_strided', 'as_strided_', 'as_tensor', 'asin', 'asin_', 'asinh', 'asinh_', 'atan', 'atan2',
 ...
 'cudnn_grid_sampler', 'cudnn_is_acceptable', 'cummax', 'cummin', 'cumprod', 'cumsum', 'deg2rad',
 'deg2rad_', 'dequantize', 'det', 'detach', 'detach_', 'diag', 'diag_embed', 'diagflat', 'diagonal',
 'diff', 'digamma', 'dist', 'div', 'divide', 'dot', 'dropout', 'dropout_', 'dsmm', 'dstack', 'eig',
 'embedding', 'embedding_bag', 'embedding_renorm_', 'empty', 'empty_like', 'empty_quantized',
 'empty_strided', 'eq', 'equal', 'erf', 'erf_', 'erfc', 'erfc_', 'erfinv', 'exp', 'exp2', 'exp2_',
 'exp_', 'expm1', 'expm1_', 'eye', 'fake_quantize_per_channel_affine',
 ...
 'fmod', 'frac', 'frac_', 'frexp', 'frobenius_norm', 'from_file', 'from_numpy', 'full', 'full_like',
 ...
 'namedtuple_mantissa_exponent', 'namedtuple_primal_tangent', 'namedtuple_sign_logabsdet',
 'namedtuple_solution_LU', 'namedtuple_solution_QR', 'namedtuple_solution_cloned_coefficient',
 'namedtuple_values_indices', 'nan_to_num', 'nan_to_num_', 'nanmedian', 'nanquantile', 'nansum',
 'narrow', 'narrow_copy', 'native_batch_norm', 'native_group_norm', 'native_layer_norm',
 ...
 'ormqr', 'outer', 'pairwise_distance', 'pdist', 'pinverse', 'pixel_shuffle', 'pixel_unshuffle',
 'poisson', 'poisson_nll_loss', 'polar', 'polygamma', 'pow', 'prelu', 'prod', 'promote_types',
 'q_per_channel_axis', 'q_per_channel_scales', 'q_per_channel_zero_points', 'q_scale',
 'q_zero_point', 'qr', 'quantile', 'quantize_per_channel', 'quantize_per_tensor',
 'quantized_batch_norm', 'quantized_gru_cell', 'quantized_lstm_cell', 'quantized_max_pool1d',
 ...
 'range', 'ravel', 'real', 'reciprocal', 'reciprocal_', 'relu', 'relu_', 'remainder', 'renorm',
 'repeat_interleave', 'reshape', 'resize_as_', 'result_type', 'rnn_relu', 'rnn_relu_cell',
 'rnn_tanh', 'rnn_tanh_cell', 'roll', 'rot90', 'round', 'round_', 'row_stack', 'rrelu', 'rrelu_',
 'rsqrt', 'rsqrt_', 'rsub', 'saddmm', 'scalar_tensor', 'scatter', 'scatter_add', 'searchsorted',
 ...
 'split_with_sizes', 'spmm', 'sqrt', 'sqrt_', 'square', 'square_', 'squeeze', 'sspaddmm', 'stack',
 'std', 'std_mean', 'sub', 'subtract', 'sum', 'svd', 'swapaxes', 'swapdims', 'symeig', 't', 'take',
 'tan', 'tan_', 'tanh', 'tanh_', 'tensor', 'tensor_split', 'threshold', 'threshold_', 'tile',
 'topk', 'trace', 'transpose', 'trapz', 'triangular_solve', 'tril', 'tril_indices',
 'triplet_margin_loss', 'triu', 'triu_indices', 'true_divide', 'trunc', 'trunc_', 'unbind',
 'unique_dim', 'unsafe_chunk', 'unsafe_split', 'unsafe_split_with_sizes', 'unsqueeze', 'vander',
 'var', 'var_mean', 'vdot', 'view_as_complex', 'view_as_real', 'vstack', 'where', 'xlogy', 'xlogy_',
