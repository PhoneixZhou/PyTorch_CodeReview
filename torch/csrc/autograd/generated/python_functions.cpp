...
PyObject* THPLinalgCholeskyBackward_result_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<LinalgCholeskyBackward*>(self->cdata.get())->result_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef LinalgCholeskyBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_result", (getter)THPLinalgCholeskyBackward_result_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPClampBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<ClampBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPClampBackward_min_getter(THPCppFunction *self, void *_unused) {
  auto opt_prop = static_cast<ClampBackward*>(self->cdata.get())->min;
  if (!opt_prop.has_value()) {
    Py_RETURN_NONE;
  }
  auto prop = opt_prop.value();
...
PyObject* THPClampBackward_max_getter(THPCppFunction *self, void *_unused) {
  auto opt_prop = static_cast<ClampBackward*>(self->cdata.get())->max;
  if (!opt_prop.has_value()) {
    Py_RETURN_NONE;
  }
  auto prop = opt_prop.value();
...
static struct PyGetSetDef ClampBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPClampBackward_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_min", (getter)THPClampBackward_min_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_max", (getter)THPClampBackward_max_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};

PyObject* THPClampMinBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<ClampMinBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPClampMinBackward_min_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<ClampMinBackward*>(self->cdata.get())->min;
  if (prop.isComplex()) {
    auto cprop = prop.to<c10::complex<double>>();
    return PyComplex_FromDoubles(cprop.real(), cprop.imag());
  } else if (prop.isFloatingPoint()) {
...
static struct PyGetSetDef ClampMinBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPClampMinBackward_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_min", (getter)THPClampMinBackward_min_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};

PyObject* THPClampMaxBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<ClampMaxBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPClampMaxBackward_max_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<ClampMaxBackward*>(self->cdata.get())->max;
  if (prop.isComplex()) {
    auto cprop = prop.to<c10::complex<double>>();
    return PyComplex_FromDoubles(cprop.real(), cprop.imag());
  } else if (prop.isFloatingPoint()) {
...
static struct PyGetSetDef ClampMaxBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPClampMaxBackward_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_max", (getter)THPClampMaxBackward_max_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPDetBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<DetBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPDetBackward_result_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<DetBackward*>(self->cdata.get())->result_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef DetBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPDetBackward_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result", (getter)THPDetBackward_result_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPDivBackward2_rounding_mode_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<DivBackward2*>(self->cdata.get())->rounding_mode;
...
PyObject* THPDivBackward3_rounding_mode_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<DivBackward3*>(self->cdata.get())->rounding_mode;
  return PyUnicode_FromString(prop.c_str());
}
...
PyObject* THPGerBackward_vec2_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<GerBackward*>(self->cdata.get())->vec2_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPGerBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<GerBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef GerBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_vec2", (getter)THPGerBackward_vec2_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_self", (getter)THPGerBackward_self_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPIndexBackward_indices_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<IndexBackward*>(self->cdata.get())->indices_;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
...
PyObject* THPIndexPutBackward_indices_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<IndexPutBackward*>(self->cdata.get())->indices_;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, THPVariable_Wrap(prop[i].unpack(self->cdata)));
  }
...
PyObject* THPIndexPutImplBackward_indices_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<IndexPutImplBackward*>(self->cdata.get())->indices_;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, THPVariable_Wrap(prop[i].unpack(self->cdata)));
  }
...
PyObject* THPLinalgInvBackward_result_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<LinalgInvBackward*>(self->cdata.get())->result_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef LinalgInvBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_result", (getter)THPLinalgInvBackward_result_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPPolygammaBackward_n_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<PolygammaBackward*>(self->cdata.get())->n;
  return PyLong_FromUnsignedLong((int64_t) prop);
}

PyObject* THPPolygammaBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<PolygammaBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef PolygammaBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_n", (getter)THPPolygammaBackward_n_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_self", (getter)THPPolygammaBackward_self_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPLinalgVectorNormBackward_ord_getter(THPCppFunction *self, void *_unused) {
  auto opt_prop = static_cast<LinalgVectorNormBackward*>(self->cdata.get())->ord;
  if (!opt_prop.has_value()) {
    Py_RETURN_NONE;
  }
  auto prop = opt_prop.value();
...
PyObject* THPStdBackward0_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdBackward0*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
static struct PyGetSetDef StdBackward0_properties[] = {
  ...
  {(char*)"_saved_unbiased", (getter)THPStdBackward0_unbiased_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result", (getter)THPStdBackward0_result_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};

PyObject* THPStdBackward1_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StdBackward1*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPStdBackward1_dim_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdBackward1*>(self->cdata.get())->dim;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, PyLong_FromUnsignedLong((uint64_t) prop[i]));
  }
...
PyObject* THPStdBackward1_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdBackward1*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPStdBackward1_keepdim_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdBackward1*>(self->cdata.get())->keepdim;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPStdBackward1_result_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StdBackward1*>(self->cdata.get())->result_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef StdBackward1_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPStdBackward1_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_dim", (getter)THPStdBackward1_dim_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_unbiased", (getter)THPStdBackward1_unbiased_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_keepdim", (getter)THPStdBackward1_keepdim_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result", (getter)THPStdBackward1_result_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPSymeigBackward_upper_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<SymeigBackward*>(self->cdata.get())->upper;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
static struct PyGetSetDef SymeigBackward_properties[] = {
  ...
  {(char*)"_saved_upper", (getter)THPSymeigBackward_upper_getter, nullptr, nullptr, nullptr},
...
PyObject* THPTakeBackward_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<TakeBackward*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}
...
static struct PyGetSetDef TakeBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPTakeBackward_self_getter, nullptr, nullptr, nullptr},
...
static struct PyGetSetDef ToSparseBackward_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
...
PyObject* THPVarBackward0_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarBackward0*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
static struct PyGetSetDef VarBackward0_properties[] = {
  ...
  {(char*)"_saved_unbiased", (getter)THPVarBackward0_unbiased_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};

PyObject* THPVarBackward1_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<VarBackward1*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPVarBackward1_dim_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarBackward1*>(self->cdata.get())->dim;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, PyLong_FromUnsignedLong((uint64_t) prop[i]));
  }
...
PyObject* THPVarBackward1_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarBackward1*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPVarBackward1_keepdim_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarBackward1*>(self->cdata.get())->keepdim;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
static struct PyGetSetDef VarBackward1_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPVarBackward1_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_dim", (getter)THPVarBackward1_dim_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_unbiased", (getter)THPVarBackward1_unbiased_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_keepdim", (getter)THPVarBackward1_keepdim_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPCudnnRnnBackward_weight_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<CudnnRnnBackward*>(self->cdata.get())->weight_;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, THPVariable_Wrap(prop[i].unpack(self->cdata)));
  }
...
PyObject* THPMiopenRnnBackward_weight_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<MiopenRnnBackward*>(self->cdata.get())->weight_;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, THPVariable_Wrap(prop[i].unpack(self->cdata)));
  }
...
PyObject* THPStackBackward_tensors_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StackBackward*>(self->cdata.get())->tensors_;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, THPVariable_Wrap(prop[i].unpack(self->cdata)));
  }
...
PyObject* THPStdMeanBackward0_dim_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdMeanBackward0*>(self->cdata.get())->dim;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, PyLong_FromUnsignedLong((uint64_t) prop[i]));
  }
...
PyObject* THPStdMeanBackward0_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdMeanBackward0*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPStdMeanBackward0_result1_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StdMeanBackward0*>(self->cdata.get())->result1_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}
...
static struct PyGetSetDef StdMeanBackward0_properties[] = {
  ...
  {(char*)"_saved_unbiased", (getter)THPStdMeanBackward0_unbiased_getter, nullptr, nullptr, nullptr},
  ...
  {(char*)"_saved_result1", (getter)THPStdMeanBackward0_result1_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
PyObject* THPVarMeanBackward0_dim_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarMeanBackward0*>(self->cdata.get())->dim;
  PyObject* tup = PyTuple_New((Py_ssize_t) prop.size());
  for (int i = 0; i < prop.size(); i++) {
    PyTuple_SetItem(tup, (Py_ssize_t) i, PyLong_FromUnsignedLong((uint64_t) prop[i]));
  }
...
PyObject* THPVarMeanBackward0_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarMeanBackward0*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPVarMeanBackward0_result0_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<VarMeanBackward0*>(self->cdata.get())->result0_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPVarMeanBackward0_result1_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<VarMeanBackward0*>(self->cdata.get())->result1_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}
...
static struct PyGetSetDef VarMeanBackward0_properties[] = {
  ...
  {(char*)"_saved_unbiased", (getter)THPVarMeanBackward0_unbiased_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_keepdim", (getter)THPVarMeanBackward0_keepdim_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result0", (getter)THPVarMeanBackward0_result0_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result1", (getter)THPVarMeanBackward0_result1_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};

PyObject* THPStdMeanBackward1_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StdMeanBackward1*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPStdMeanBackward1_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<StdMeanBackward1*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPStdMeanBackward1_result0_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StdMeanBackward1*>(self->cdata.get())->result0_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPStdMeanBackward1_result1_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<StdMeanBackward1*>(self->cdata.get())->result1_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef StdMeanBackward1_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPStdMeanBackward1_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_unbiased", (getter)THPStdMeanBackward1_unbiased_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result0", (getter)THPStdMeanBackward1_result0_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result1", (getter)THPStdMeanBackward1_result1_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};

PyObject* THPVarMeanBackward1_self_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<VarMeanBackward1*>(self->cdata.get())->self_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPVarMeanBackward1_unbiased_getter(THPCppFunction *self, void *_unused) {
  auto prop = static_cast<VarMeanBackward1*>(self->cdata.get())->unbiased;
  if (prop) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
...
PyObject* THPVarMeanBackward1_result0_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<VarMeanBackward1*>(self->cdata.get())->result0_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

PyObject* THPVarMeanBackward1_result1_getter(THPCppFunction *self, void *_unused) {
  const auto& prop = static_cast<VarMeanBackward1*>(self->cdata.get())->result1_;
  return THPVariable_Wrap(prop.unpack(self->cdata));
}

static struct PyGetSetDef VarMeanBackward1_properties[] = {
  THP_FUNCTION_DEFAULT_PROPERTIES,
  {(char*)"_saved_self", (getter)THPVarMeanBackward1_self_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_unbiased", (getter)THPVarMeanBackward1_unbiased_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result0", (getter)THPVarMeanBackward1_result0_getter, nullptr, nullptr, nullptr},
  {(char*)"_saved_result1", (getter)THPVarMeanBackward1_result1_getter, nullptr, nullptr, nullptr},
  {nullptr} /* sentinel */
};
...
void initialize_autogenerated_functions() {
  ...
  static PyTypeObject LinalgCholeskyBackwardClass;
  addClass<LinalgCholeskyBackward>(LinalgCholeskyBackwardClass, "LinalgCholeskyBackward", LinalgCholeskyBackward_properties);
  ...
  addClass<ClampBackward>(ClampBackwardClass, "ClampBackward", ClampBackward_properties);
  static PyTypeObject ClampMinBackwardClass;
  addClass<ClampMinBackward>(ClampMinBackwardClass, "ClampMinBackward", ClampMinBackward_properties);
  static PyTypeObject ClampMaxBackwardClass;
  addClass<ClampMaxBackward>(ClampMaxBackwardClass, "ClampMaxBackward", ClampMaxBackward_properties);
  ...
  addClass<DetBackward>(DetBackwardClass, "DetBackward", DetBackward_properties);
  ...
  addClass<GerBackward>(GerBackwardClass, "GerBackward", GerBackward_properties);
  ...
  static PyTypeObject LinalgInvBackwardClass;
  addClass<LinalgInvBackward>(LinalgInvBackwardClass, "LinalgInvBackward", LinalgInvBackward_properties);
  ...
  addClass<PolygammaBackward>(PolygammaBackwardClass, "PolygammaBackward", PolygammaBackward_properties);
  ...
  addClass<StdBackward0>(StdBackward0Class, "StdBackward0", StdBackward0_properties);
  static PyTypeObject StdBackward1Class;
  addClass<StdBackward1>(StdBackward1Class, "StdBackward1", StdBackward1_properties);
  ...
  addClass<ToSparseBackward>(ToSparseBackwardClass, "ToSparseBackward", ToSparseBackward_properties);
  ...
  addClass<VarBackward0>(VarBackward0Class, "VarBackward0", VarBackward0_properties);
  static PyTypeObject VarBackward1Class;
  addClass<VarBackward1>(VarBackward1Class, "VarBackward1", VarBackward1_properties);
  ...
  addClass<StdMeanBackward0>(StdMeanBackward0Class, "StdMeanBackward0", StdMeanBackward0_properties);
  static PyTypeObject VarMeanBackward0Class;
  addClass<VarMeanBackward0>(VarMeanBackward0Class, "VarMeanBackward0", VarMeanBackward0_properties);
  static PyTypeObject StdMeanBackward1Class;
  addClass<StdMeanBackward1>(StdMeanBackward1Class, "StdMeanBackward1", StdMeanBackward1_properties);
  static PyTypeObject VarMeanBackward1Class;
  addClass<VarMeanBackward1>(VarMeanBackward1Class, "VarMeanBackward1", VarMeanBackward1_properties);
}
