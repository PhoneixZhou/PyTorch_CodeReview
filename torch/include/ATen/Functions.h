...
TORCH_API void _assert_async(const Tensor & self);
...
TORCH_API Tensor & add_outf(const Tensor & self, const Tensor & other, const Scalar & alpha, Tensor & out);
TORCH_API Tensor _add_relu(const Tensor & self, const Tensor & other, const Scalar & alpha=1);
TORCH_API Tensor & _add_relu_(Tensor & self, const Tensor & other, const Scalar & alpha=1);
TORCH_API Tensor & _add_relu_out(Tensor & out, const Tensor & self, const Tensor & other, const Scalar & alpha=1);
TORCH_API Tensor & _add_relu_outf(const Tensor & self, const Tensor & other, const Scalar & alpha, Tensor & out);
...
TORCH_API Tensor & addmv_out(Tensor & out, const Tensor & self, const Tensor & mat, const Tensor & vec, const Scalar & beta=1, const Scalar & alpha=1);
TORCH_API Tensor & addmv_outf(const Tensor & self, const Tensor & mat, const Tensor & vec, const Scalar & beta, const Scalar & alpha, Tensor & out);
TORCH_API Tensor & _addmv_impl_(Tensor & self, const Tensor & self2, const Tensor & mat, const Tensor & vec, const Scalar & beta=1, const Scalar & alpha=1);
...
TORCH_API Tensor & arange_out(Tensor & out, const Scalar & start, const Scalar & end, const Scalar & step=1);
TORCH_API Tensor & arange_outf(const Scalar & start, const Scalar & end, const Scalar & step, Tensor & out);
...
TORCH_API Tensor baddbmm(const Tensor & self, const Tensor & batch1, const Tensor & batch2, const Scalar & beta=1, const Scalar & alpha=1);
...
TORCH_API Tensor & baddbmm_out(Tensor & out, const Tensor & self, const Tensor & batch1, const Tensor & batch2, const Scalar & beta=1, const Scalar & alpha=1);
TORCH_API Tensor & baddbmm_outf(const Tensor & self, const Tensor & batch1, const Tensor & batch2, const Scalar & beta, const Scalar & alpha, Tensor & out);
...
TORCH_API Tensor & clamp_out(Tensor & out, const Tensor & self, const c10::optional<Scalar> & min=c10::nullopt, const c10::optional<Scalar> & max=c10::nullopt);
TORCH_API Tensor & clamp_outf(const Tensor & self, const c10::optional<Scalar> & min, const c10::optional<Scalar> & max, Tensor & out);
TORCH_API Tensor clamp_max(const Tensor & self, const Scalar & max);
TORCH_API Tensor & clamp_max_(Tensor & self, const Scalar & max);
TORCH_API Tensor & clamp_max_out(Tensor & out, const Tensor & self, const Scalar & max);
TORCH_API Tensor & clamp_max_outf(const Tensor & self, const Scalar & max, Tensor & out);
TORCH_API Tensor clamp_min(const Tensor & self, const Scalar & min);
TORCH_API Tensor & clamp_min_(Tensor & self, const Scalar & min);
TORCH_API Tensor & clamp_min_out(Tensor & out, const Tensor & self, const Scalar & min);
TORCH_API Tensor & clamp_min_outf(const Tensor & self, const Scalar & min, Tensor & out);
...
TORCH_API Tensor _convolution_mode(const Tensor & input, const Tensor & weight, const c10::optional<Tensor> & bias, IntArrayRef stride, std::string padding, IntArrayRef dilation, int64_t groups);
...
TORCH_API Tensor conv1d(const Tensor & input, const Tensor & weight, const c10::optional<Tensor> & bias, IntArrayRef stride, std::string padding, IntArrayRef dilation=1, int64_t groups=1);
TORCH_API Tensor conv2d(const Tensor & input, const Tensor & weight, const c10::optional<Tensor> & bias, IntArrayRef stride, std::string padding, IntArrayRef dilation=1, int64_t groups=1);
TORCH_API Tensor conv3d(const Tensor & input, const Tensor & weight, const c10::optional<Tensor> & bias, IntArrayRef stride, std::string padding, IntArrayRef dilation=1, int64_t groups=1);
...
TORCH_API bool __dispatch_is_floating_point(const Tensor & self);
TORCH_API bool __dispatch_is_complex(const Tensor & self);
...
TORCH_API bool __dispatch_is_signed(const Tensor & self);
...
TORCH_API Tensor & linspace_out(Tensor & out, const Scalar & start, const Scalar & end, c10::optional<int64_t> steps=c10::nullopt);
TORCH_API Tensor & linspace_outf(const Scalar & start, const Scalar & end, c10::optional<int64_t> steps, Tensor & out);
...
TORCH_API Tensor & xlogy_out(Tensor & out, const Scalar & self, const Tensor & other);
TORCH_API Tensor & xlogy_outf(const Scalar & self, const Tensor & other, Tensor & out);
TORCH_API Tensor & xlogy_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & xlogy_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & logspace_out(Tensor & out, const Scalar & start, const Scalar & end, c10::optional<int64_t> steps=c10::nullopt, double base=10.0);
TORCH_API Tensor & logspace_outf(const Scalar & start, const Scalar & end, c10::optional<int64_t> steps, double base, Tensor & out);
...
TORCH_API Tensor & matrix_power_out(Tensor & out, const Tensor & self, int64_t n);
TORCH_API Tensor & matrix_power_outf(const Tensor & self, int64_t n, Tensor & out);
...
TORCH_API Tensor _sparse_mask_helper(const Tensor & t, const Tensor & mask_indices);
...
TORCH_API Tensor batch_norm_backward_elemt(const Tensor & grad_out, const Tensor & input, const Tensor & mean, const Tensor & invstd, const c10::optional<Tensor> & weight, const Tensor & mean_dy, const Tensor & mean_dy_xmu, const Tensor & count);
...
TORCH_API Tensor & range_out(Tensor & out, const Scalar & start, const Scalar & end, const Scalar & step=1);
TORCH_API Tensor & range_outf(const Scalar & start, const Scalar & end, const Scalar & step, Tensor & out);
...
TORCH_API Tensor & sspaddmm_out(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, const Scalar & beta=1, const Scalar & alpha=1);
TORCH_API Tensor & sspaddmm_outf(const Tensor & self, const Tensor & mat1, const Tensor & mat2, const Scalar & beta, const Scalar & alpha, Tensor & out);
...
TORCH_API Tensor & square_out(Tensor & out, const Tensor & self);
TORCH_API Tensor & square_outf(const Tensor & self, Tensor & out);
...
TORCH_API Tensor & threshold_out(Tensor & out, const Tensor & self, const Scalar & threshold, const Scalar & value);
TORCH_API Tensor & threshold_outf(const Tensor & self, const Scalar & threshold, const Scalar & value, Tensor & out);
...
TORCH_API Tensor native_norm(const Tensor & self, const Scalar & p=2);
TORCH_API Tensor native_norm(const Tensor & self, const c10::optional<Scalar> & p, IntArrayRef dim, bool keepdim, c10::optional<ScalarType> dtype);
...
TORCH_API Tensor & norm_out(Tensor & out, const Tensor & self, const c10::optional<Scalar> & p, IntArrayRef dim, bool keepdim, ScalarType dtype);
TORCH_API Tensor & norm_outf(const Tensor & self, const c10::optional<Scalar> & p, IntArrayRef dim, bool keepdim, ScalarType dtype, Tensor & out);
TORCH_API Tensor & norm_out(Tensor & out, const Tensor & self, const c10::optional<Scalar> & p, IntArrayRef dim, bool keepdim=false);
TORCH_API Tensor & norm_outf(const Tensor & self, const c10::optional<Scalar> & p, IntArrayRef dim, bool keepdim, Tensor & out);
...
TORCH_API Tensor & sub_out(Tensor & out, const Tensor & self, const Tensor & other, const Scalar & alpha=1);
TORCH_API Tensor & sub_outf(const Tensor & self, const Tensor & other, const Scalar & alpha, Tensor & out);
TORCH_API Tensor sub(const Tensor & self, const Tensor & other, const Scalar & alpha=1);
...
TORCH_API Tensor & addmm_out(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, const Scalar & beta=1, const Scalar & alpha=1);
TORCH_API Tensor & addmm_outf(const Tensor & self, const Tensor & mat1, const Tensor & mat2, const Scalar & beta, const Scalar & alpha, Tensor & out);
TORCH_API Tensor addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, const Scalar & beta=1, const Scalar & alpha=1);
...
TORCH_API Tensor & bitwise_and_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & bitwise_and_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & bitwise_or_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & bitwise_or_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & bitwise_xor_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & bitwise_xor_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & addbmm_out(Tensor & out, const Tensor & self, const Tensor & batch1, const Tensor & batch2, const Scalar & beta=1, const Scalar & alpha=1);
TORCH_API Tensor & addbmm_outf(const Tensor & self, const Tensor & batch1, const Tensor & batch2, const Scalar & beta, const Scalar & alpha, Tensor & out);
...
TORCH_API Tensor & ne_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & ne_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & eq_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & eq_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & ge_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & ge_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & le_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & le_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & gt_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & gt_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & lt_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & lt_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & addcmul_outf(const Tensor & self, const Tensor & tensor1, const Tensor & tensor2, const Scalar & value, Tensor & out);
TORCH_API Tensor addcmul(const Tensor & self, const Tensor & tensor1, const Tensor & tensor2, const Scalar & value=1);
TORCH_API Tensor & addcdiv_out(Tensor & out, const Tensor & self, const Tensor & tensor1, const Tensor & tensor2, const Scalar & value=1);
TORCH_API Tensor & addcdiv_outf(const Tensor & self, const Tensor & tensor1, const Tensor & tensor2, const Scalar & value, Tensor & out);
...
TORCH_API Tensor & lerp_out(Tensor & out, const Tensor & self, const Tensor & end, const Scalar & weight);
TORCH_API Tensor & lerp_outf(const Tensor & self, const Tensor & end, const Scalar & weight, Tensor & out);
...
TORCH_API Tensor lerp(const Tensor & self, const Tensor & end, const Scalar & weight);
TORCH_API Tensor lerp(const Tensor & self, const Tensor & end, const Tensor & weight);
TORCH_API Tensor & histc_out(Tensor & out, const Tensor & self, int64_t bins=100, const Scalar & min=0, const Scalar & max=0);
TORCH_API Tensor & histc_outf(const Tensor & self, int64_t bins, const Scalar & min, const Scalar & max, Tensor & out);
TORCH_API Tensor histc(const Tensor & self, int64_t bins=100, const Scalar & min=0, const Scalar & max=0);
TORCH_API Tensor & fmod_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & fmod_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API Tensor & remainder_out(Tensor & out, const Tensor & self, const Scalar & other);
TORCH_API Tensor & remainder_outf(const Tensor & self, const Scalar & other, Tensor & out);
...
TORCH_API std::tuple<Tensor &,Tensor &> sort_out(Tensor & values, Tensor & indices, const Tensor & self, c10::optional<bool> stable, int64_t dim=-1, bool descending=false);
TORCH_API std::tuple<Tensor &,Tensor &> sort_outf(const Tensor & self, c10::optional<bool> stable, int64_t dim, bool descending, Tensor & values, Tensor & indices);
TORCH_API std::tuple<Tensor,Tensor> sort(const Tensor & self, int64_t dim=-1, bool descending=false);
TORCH_API std::tuple<Tensor,Tensor> sort(const Tensor & self, c10::optional<bool> stable, int64_t dim=-1, bool descending=false);
...
TORCH_API Tensor & renorm_out(Tensor & out, const Tensor & self, const Scalar & p, int64_t dim, const Scalar & maxnorm);
TORCH_API Tensor & renorm_outf(const Tensor & self, const Scalar & p, int64_t dim, const Scalar & maxnorm, Tensor & out);
TORCH_API Tensor renorm(const Tensor & self, const Scalar & p, int64_t dim, const Scalar & maxnorm);
...
TORCH_API Tensor & pow_out(Tensor & out, const Scalar & self, const Tensor & exponent);
TORCH_API Tensor & pow_outf(const Scalar & self, const Tensor & exponent, Tensor & out);
TORCH_API Tensor pow(const Scalar & self, const Tensor & exponent);
TORCH_API Tensor & pow_out(Tensor & out, const Tensor & self, const Scalar & exponent);
TORCH_API Tensor & pow_outf(const Tensor & self, const Scalar & exponent, Tensor & out);
TORCH_API Tensor pow(const Tensor & self, const Scalar & exponent);
...
TORCH_API std::vector<Tensor> _foreach_add(TensorList tensors, const Scalar & scalar);
TORCH_API void _foreach_add_(TensorList self, const Scalar & scalar);
TORCH_API std::vector<Tensor> _foreach_sub(TensorList tensors, const Scalar & scalar);
TORCH_API void _foreach_sub_(TensorList self, const Scalar & scalar);
TORCH_API std::vector<Tensor> _foreach_mul(TensorList tensors, const Scalar & scalar);
TORCH_API void _foreach_mul_(TensorList self, const Scalar & scalar);
TORCH_API std::vector<Tensor> _foreach_div(TensorList tensors, const Scalar & scalar);
TORCH_API void _foreach_div_(TensorList self, const Scalar & scalar);
TORCH_API std::vector<Tensor> _foreach_add(TensorList tensors1, TensorList tensors2, const Scalar & alpha=1);
TORCH_API void _foreach_add_(TensorList self, TensorList other, const Scalar & alpha=1);
TORCH_API std::vector<Tensor> _foreach_sub(TensorList tensors1, TensorList tensors2, const Scalar & alpha=1);
TORCH_API void _foreach_sub_(TensorList self, TensorList other, const Scalar & alpha=1);
...
TORCH_API std::vector<Tensor> _foreach_add(TensorList tensors, ArrayRef<Scalar> scalars);
TORCH_API void _foreach_add_(TensorList self, ArrayRef<Scalar> scalars);
TORCH_API std::vector<Tensor> _foreach_sub(TensorList tensors, ArrayRef<Scalar> scalars);
TORCH_API void _foreach_sub_(TensorList self, ArrayRef<Scalar> scalars);
TORCH_API std::vector<Tensor> _foreach_div(TensorList tensors, ArrayRef<Scalar> scalars);
TORCH_API void _foreach_div_(TensorList self, ArrayRef<Scalar> scalars);
TORCH_API std::vector<Tensor> _foreach_mul(TensorList tensors, ArrayRef<Scalar> scalars);
TORCH_API void _foreach_mul_(TensorList self, ArrayRef<Scalar> scalars);
...
TORCH_API void _foreach_addcdiv_(TensorList self, TensorList tensor1, TensorList tensor2, const Scalar & value=1);
TORCH_API void _foreach_addcmul_(TensorList self, TensorList tensor1, TensorList tensor2, const Scalar & value=1);
TORCH_API void _foreach_addcdiv_(TensorList self, TensorList tensor1, TensorList tensor2, ArrayRef<Scalar> scalars);
TORCH_API void _foreach_addcmul_(TensorList self, TensorList tensor1, TensorList tensor2, ArrayRef<Scalar> scalars);
TORCH_API std::vector<Tensor> _foreach_addcdiv(TensorList input, TensorList tensor1, TensorList tensor2, const Scalar & value=1);
TORCH_API std::vector<Tensor> _foreach_addcmul(TensorList input, TensorList tensor1, TensorList tensor2, const Scalar & value=1);
TORCH_API std::vector<Tensor> _foreach_addcdiv(TensorList input, TensorList tensor1, TensorList tensor2, ArrayRef<Scalar> scalars);
TORCH_API std::vector<Tensor> _foreach_addcmul(TensorList input, TensorList tensor1, TensorList tensor2, ArrayRef<Scalar> scalars);
...
TORCH_API Tensor bucketize(const Scalar & self, const Tensor & boundaries, bool out_int32=false, bool right=false);
...
TORCH_API Tensor searchsorted(const Tensor & sorted_sequence, const Scalar & self, bool out_int32=false, bool right=false);
...
TORCH_API Tensor & multi_margin_loss_out(Tensor & out, const Tensor & self, const Tensor & target, const Scalar & p=1, const Scalar & margin=1, const c10::optional<Tensor> & weight={}, int64_t reduction=at::Reduction::Mean);
TORCH_API Tensor & multi_margin_loss_outf(const Tensor & self, const Tensor & target, const Scalar & p, const Scalar & margin, const c10::optional<Tensor> & weight, int64_t reduction, Tensor & out);
TORCH_API Tensor multi_margin_loss(const Tensor & self, const Tensor & target, const Scalar & p=1, const Scalar & margin=1, const c10::optional<Tensor> & weight={}, int64_t reduction=at::Reduction::Mean);
TORCH_API Tensor & multi_margin_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, const Scalar & p, const Scalar & margin, const c10::optional<Tensor> & weight={}, int64_t reduction=at::Reduction::Mean);
TORCH_API Tensor & multi_margin_loss_backward_outf(const Tensor & grad_output, const Tensor & self, const Tensor & target, const Scalar & p, const Scalar & margin, const c10::optional<Tensor> & weight, int64_t reduction, Tensor & grad_input);
TORCH_API Tensor multi_margin_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, const Scalar & p, const Scalar & margin, const c10::optional<Tensor> & weight={}, int64_t reduction=at::Reduction::Mean);
...
TORCH_API Tensor & huber_loss_out(Tensor & out, const Tensor & self, const Tensor & target, int64_t reduction=at::Reduction::Mean, double delta=1.0);
TORCH_API Tensor & huber_loss_outf(const Tensor & self, const Tensor & target, int64_t reduction, double delta, Tensor & out);
TORCH_API Tensor huber_loss(const Tensor & self, const Tensor & target, int64_t reduction=at::Reduction::Mean, double delta=1.0);
TORCH_API Tensor & huber_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction, double delta);
TORCH_API Tensor & huber_loss_backward_outf(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction, double delta, Tensor & grad_input);
...
TORCH_API Tensor & elu_outf(const Tensor & self, const Scalar & alpha, const Scalar & scale, const Scalar & input_scale, Tensor & out);
...
TORCH_API Tensor & hardtanh_outf(const Tensor & self, const Scalar & min_val, const Scalar & max_val, Tensor & out);
...
TORCH_API Tensor & hardtanh_backward_outf(const Tensor & grad_output, const Tensor & self, const Scalar & min_val, const Scalar & max_val, Tensor & grad_input);
...
TORCH_API Tensor & leaky_relu_outf(const Tensor & self, const Scalar & negative_slope, Tensor & out);
...
TORCH_API Tensor & rrelu_with_noise_out(Tensor & out, const Tensor & self, const Tensor & noise, const Scalar & lower=0.125, const Scalar & upper=0.3333333333333333, bool training=false, c10::optional<Generator> generator=c10::nullopt);
TORCH_API Tensor & rrelu_with_noise_outf(const Tensor & self, const Tensor & noise, const Scalar & lower, const Scalar & upper, bool training, c10::optional<Generator> generator, Tensor & out);
TORCH_API Tensor rrelu_with_noise(const Tensor & self, const Tensor & noise, const Scalar & lower=0.125, const Scalar & upper=0.3333333333333333, bool training=false, c10::optional<Generator> generator=c10::nullopt);
...
TORCH_API Tensor & rrelu_with_noise_(Tensor & self, const Tensor & noise, const Scalar & lower=0.125, const Scalar & upper=0.3333333333333333, bool training=false, c10::optional<Generator> generator=c10::nullopt);
TORCH_API Tensor & softplus_out(Tensor & out, const Tensor & self, const Scalar & beta=1, const Scalar & threshold=20);
TORCH_API Tensor & softplus_outf(const Tensor & self, const Scalar & beta, const Scalar & threshold, Tensor & out);
...
TORCH_API Tensor & softplus_backward_outf(const Tensor & grad_output, const Tensor & self, const Scalar & beta, const Scalar & threshold, const Tensor & output, Tensor & grad_input);
...
TORCH_API Tensor & softshrink_outf(const Tensor & self, const Scalar & lambd, Tensor & out);
...
TORCH_API Tensor & softshrink_backward_outf(const Tensor & grad_output, const Tensor & self, const Scalar & lambd, Tensor & grad_input);
...
TORCH_API Tensor conv_depthwise3d(const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const c10::optional<Tensor> & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation);
TORCH_API std::tuple<Tensor &,Tensor &,Tensor &> conv_depthwise3d_backward_out(Tensor & grad_input, Tensor & grad_weight, Tensor & grad_bias, const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation);
TORCH_API std::tuple<Tensor &,Tensor &,Tensor &> conv_depthwise3d_backward_outf(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, Tensor & grad_input, Tensor & grad_weight, Tensor & grad_bias);
TORCH_API std::tuple<Tensor,Tensor,Tensor> conv_depthwise3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, std::array<bool,3> output_mask);
...
TORCH_API Tensor & special_entr_out(Tensor & out, const Tensor & self);
TORCH_API Tensor & special_entr_outf(const Tensor & self, Tensor & out);
TORCH_API Tensor special_gammaln(const Tensor & self);
TORCH_API Tensor & special_gammaln_out(Tensor & out, const Tensor & self);
TORCH_API Tensor & special_gammaln_outf(const Tensor & self, Tensor & out);
TORCH_API Tensor special_erf(const Tensor & self);
TORCH_API Tensor & special_erf_out(Tensor & out, const Tensor & self);
TORCH_API Tensor & special_erf_outf(const Tensor & self, Tensor & out);
TORCH_API Tensor special_erfc(const Tensor & self);
TORCH_API Tensor & special_erfc_out(Tensor & out, const Tensor & self);
TORCH_API Tensor & special_erfc_outf(const Tensor & self, Tensor & out);
TORCH_API Tensor special_erfinv(const Tensor & self);
TORCH_API Tensor & special_erfinv_out(Tensor & out, const Tensor & self);
TORCH_API Tensor & special_erfinv_outf(const Tensor & self, Tensor & out);
...
TORCH_API std::tuple<Tensor,Tensor,Tensor> _lstsq_helper(const Tensor & a, const Tensor & b, double cond, c10::optional<std::string> driver_name);
...
TORCH_API Tensor & linalg_householder_product_out(Tensor & out, const Tensor & input, const Tensor & tau);
TORCH_API Tensor & linalg_householder_product_outf(const Tensor & input, const Tensor & tau, Tensor & out);
...
TORCH_API Tensor & linalg_vector_norm_out(Tensor & out, const Tensor & self, const c10::optional<Scalar> & ord=c10::nullopt, c10::optional<IntArrayRef> dim=c10::nullopt, bool keepdim=false, c10::optional<ScalarType> dtype=c10::nullopt);
TORCH_API Tensor & linalg_vector_norm_outf(const Tensor & self, const c10::optional<Scalar> & ord, c10::optional<IntArrayRef> dim, bool keepdim, c10::optional<ScalarType> dtype, Tensor & out);
...
TORCH_API Tensor & linalg_matrix_power_out(Tensor & out, const Tensor & self, int64_t n);
TORCH_API Tensor & linalg_matrix_power_outf(const Tensor & self, int64_t n, Tensor & out);
...
TORCH_API Tensor segment_reduce(const Tensor & data, std::string reduce, const c10::optional<Tensor> & lengths={}, const c10::optional<Tensor> & indices={}, int64_t axis=0, bool unsafe=false);
