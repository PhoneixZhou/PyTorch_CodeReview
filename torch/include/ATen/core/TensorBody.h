...
class TORCH_API Tensor {
 ...
 public:
  ...
  Tensor div(const Scalar & other, std::string rounding_mode) const;
  Tensor & div_(const Scalar & other, std::string rounding_mode) const;
  ...
  Tensor divide(const Scalar & other, std::string rounding_mode) const;
  Tensor & divide_(const Scalar & other, std::string rounding_mode) const;
