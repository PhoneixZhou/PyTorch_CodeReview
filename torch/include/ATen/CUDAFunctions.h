...
TORCH_API Tensor & baddbmm_(Tensor & self, const Tensor & batch1, const Tensor & batch2, const Scalar & beta=1, const Scalar & alpha=1);
...
TORCH_API Tensor & sub_(Tensor & self, const Tensor & other, const Scalar & alpha=1);
...
TORCH_API Tensor & addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, const Scalar & beta=1, const Scalar & alpha=1);
...
TORCH_API Tensor & masked_fill_(Tensor & self, const Tensor & mask, const Scalar & value);
...
TORCH_API Tensor & scatter_(Tensor & self, int64_t dim, const Tensor & index, const Scalar & value);
TORCH_API Tensor & scatter_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & src, std::string reduce);
TORCH_API Tensor & scatter_(Tensor & self, int64_t dim, const Tensor & index, const Scalar & value, std::string reduce);
...
TORCH_API Tensor & renorm_(Tensor & self, const Scalar & p, int64_t dim, const Scalar & maxnorm);
...
TORCH_API Tensor & lerp_(Tensor & self, const Tensor & end, const Scalar & weight);
...
TORCH_API Tensor & pow_(Tensor & self, const Scalar & exponent);
