...
annotated_args = {
    ...
    torch._C._VariableFunctions._convolution: [{'name': 'input', 'simple_type': 'Tensor'}, {'name': 'weight', 'simple_type': 'Tensor'}, {'name': 'bias', 'simple_type': 'Tensor?'}, {'name': 'stride', 'simple_type': 'IntArrayRef'}, {'name': 'padding', 'simple_type': 'IntArrayRef'}, {'name': 'dilation', 'simple_type': 'IntArrayRef'}, {'name': 'transposed', 'simple_type': 'bool'}, {'name': 'output_padding', 'simple_type': 'IntArrayRef'}, {'name': 'groups', 'simple_type': 'int64_t'}, {'name': 'benchmark', 'simple_type': 'bool'}, {'name': 'deterministic', 'simple_type': 'bool'}, {'name': 'cudnn_enabled', 'simple_type': 'bool'}],
    torch._C._VariableFunctions._convolution_mode: [{'name': 'input', 'simple_type': 'Tensor'}, {'name': 'weight', 'simple_type': 'Tensor'}, {'name': 'bias', 'simple_type': 'Tensor?'}, {'name': 'stride', 'simple_type': 'IntArrayRef'}, {'name': 'padding', 'simple_type': 'std::string'}, {'name': 'dilation', 'simple_type': 'IntArrayRef'}, {'name': 'groups', 'simple_type': 'int64_t'}],
    ...
    torch._C._VariableFunctions._lstsq_helper: [{'name': 'a', 'simple_type': 'Tensor'}, {'name': 'b', 'simple_type': 'Tensor'}, {'name': 'cond', 'simple_type': 'double'}, {'name': 'driver_name', 'simple_type': 'std::string?'}],
    ...
    torch._C._VariableFunctions.segment_reduce: [{'name': 'data', 'simple_type': 'Tensor'}, {'name': 'reduce', 'simple_type': 'std::string'}],
    ...
    torch._C._linalg.linalg_norm: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'ord', 'simple_type': 'std::string'}],
    torch._C._linalg.linalg_norm: [{'name': 'self', 'simple_type': 'Tensor'}],
    torch._C._linalg.linalg_norm: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'ord', 'simple_type': 'std::string'}],
    ...
    torch._C._linalg.linalg_cond: [{'name': 'self', 'simple_type': 'Tensor'}],
    torch._C._linalg.linalg_cond: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'p', 'simple_type': 'std::string'}],
    torch._C._linalg.linalg_cond: [{'name': 'self', 'simple_type': 'Tensor'}, {'name': 'p', 'simple_type': 'std::string'}],
